...
export function getRankingsAPI() {
  ...
  const GET_RANKINGS_URL = 'http://3.38.13.222:8888/challenges/rankings';
...
export function getMainLayoutChallengeListAPI(categoryNo) {
  ...
  const GET_CHALLENGE_LIST_BY_CATEGORY_URL = 'http://3.38.13.222:8888/challenges/category/' + categoryNo;
